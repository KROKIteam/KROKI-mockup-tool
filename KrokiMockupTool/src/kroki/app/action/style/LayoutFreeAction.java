...
public class LayoutFreeAction extends AbstractAction {
    ...
    public LayoutFreeAction() {
        ...
        putValue(SHORT_DESCRIPTION, StringResource.getStringResource("action.freeLayout.description"));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        ChangeLayoutCommand changeLayoutCommand = new ChangeLayoutCommand(GroupOrientation.area, (ElementsGroup) visibleElement);
