...
public class AddTextAreaAction extends AbstractAction {
    ...
    ImageIcon smallIcon = new ImageIcon(ImageResource.getImageResource("action.addTextArea.smallImage"));
    Image addEnabledIcon = CursorResource.getCursorResource("action.addTextArea.smallImage");
