...
public class AddRadioButtonAction extends AbstractAction {
	...
	private ImageIcon smallIcon = new ImageIcon(ImageResource.getImageResource("action.addRadioButton.smallImage"));
	private Image addEnabledIcon = CursorResource.getCursorResource("action.addRadioButton.smallImage");
