...
public class AddCheckBoxesAction extends AbstractAction {
    ...
    private ImageIcon smallIcon = new ImageIcon(ImageResource.getImageResource("action.addCheckBoxes.smallImage"));
    private Image addEnabledIcon = CursorResource.getCursorResource("action.addCheckBoxes.smallImage");
