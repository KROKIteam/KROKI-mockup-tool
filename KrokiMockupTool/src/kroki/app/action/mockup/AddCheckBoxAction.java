...
public class AddCheckBoxAction extends AbstractAction {
    ...
    public AddCheckBoxAction() {
        ...
        putValue(NAME, StringResource.getStringResource("action.addCheckBox.name"));
        putValue(SHORT_DESCRIPTION, StringResource.getStringResource("action.addCheckBox.description"));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        VisibleProperty visibleProperty = new VisibleProperty("check_box_1", true, ComponentType.CHECK_BOX);
