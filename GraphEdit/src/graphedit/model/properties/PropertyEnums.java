...
public interface PropertyEnums {
	...
	public enum LinkProperties implements PropertyEnums {
		NAME,SOURCE_CARDINALITY, DESTINATION_CARDINALITY, SOURCE_ROLE, DESTINATION_ROLE,STEREOTYPE,
		SOURCE_NAVIGABLE,DESTINATION_NAVIGABLE, SHOW_SOURCE_ROLE, SHOW_DESTINATION_ROLE
	}
