...
public class AllPosibleHierarchyPanels extends Visitor {
    ...
    public void visit(Object object) {
        ...
        if (parentChild.getHierarchyCount() == 0) {
            return;
        }
        if (parentChild.getHierarchyCount() == 1) {
            VisibleClass rootPanel = parentChild.getHierarchyRoot().getTargetPanel();
            objectList.remove(rootPanel);
        }
    }
