...
public class EntityHelper {
	 ...
	 */
	public static AbsAttribute getAttribute(EntityBean bean, String name)
			throws EntityAttributeNotFoundException {
		Iterator<AbsAttribute> it = bean.getAttributes().iterator();
	...
	public static JoinColumnAttribute getJoinByLookup(EntityBean bean,
